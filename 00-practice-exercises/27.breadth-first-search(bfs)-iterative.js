...
console.log(g.depthFirstIterativeImproved("A")); // [ 'A', 'C', 'E', 'F', 'D', 'B' ]

console.log(g.breadthFirstLeftToRight("A")); // [ 'A', 'B', 'C', 'D', 'E', 'F' ]
console.log(g.breadthFirstRightToLeft("A")); // [ 'A', 'B', 'C', 'D', 'E', 'F' ]
